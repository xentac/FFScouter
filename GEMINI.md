...
- **No lint/analysis warnings/errors:** Verify that `bun run biome` completes with no errors/warnings. EXCEPTION: `src/ffscouter.js` is the old version of the script that can have errors, eventually this file will be fully fixed or deleted.
